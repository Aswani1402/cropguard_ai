...
REPORT_PATH = METRICS_DIR / "efficientnetv2b0_classification_report.csv"
HISTORY_PATH = LOGS_DIR / "efficientnetv2b0_history.csv"
...
def main():
    print("\nChecking EfficientNetV2B0 output files...\n")
    ...
    print("\nEfficientNetV2B0 verification completed successfully.")
