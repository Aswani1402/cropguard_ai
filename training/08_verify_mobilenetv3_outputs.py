...
REPORT_PATH = METRICS_DIR / "mobilenetv3large_classification_report.csv"
HISTORY_PATH = LOGS_DIR / "mobilenetv3large_history.csv"
...
def main():
    print("\nChecking MobileNetV3Large output files...\n")
    ...
    print("\nLoading MobileNetV3Large model...")
    ...
    print("\nMobileNetV3Large verification completed successfully.")
